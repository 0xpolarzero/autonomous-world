...
library Count {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Count", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000436f756e740000000000000000000000);
